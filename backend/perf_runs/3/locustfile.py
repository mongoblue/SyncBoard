...
产物目录: D:/Projects/SyncBoard/backend/perf_runs/3
步骤: ['main']
"""
...
# ── 指标配置 ──────────────────────────────────────────────────
METRICS_FILE = r"C:\\Users\\MONGOB~1\\AppData\\Local\\Temp\\syncboard-locust\\locust_metrics_prepare_3.json"
METRICS_TMP = r"C:\Users\MONGOB~1\AppData\Local\Temp\syncboard-locust\locust_metrics_prepare_3.json.tmp"
_STEP_NAMES = ['main']
_RPS_LIMIT = None
...
class PerformanceTestUser(HttpUser):
    ...
    # ── Step 1: main ────────────────────────────────
    _url_0 = _resolve_vars('https://example.com/api/test', ctx)
    _headers_0 = _resolve_headers({}, ctx)
    _body_0 = _resolve_body(None, ctx)
