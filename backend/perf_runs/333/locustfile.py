...
产物目录: D:/Projects/SyncBoard/backend/perf_runs/333
步骤: ['main']
"""
...
# ── 指标配置 ──────────────────────────────────────────────────
METRICS_FILE = r"C:\\Users\\MONGOB~1\\AppData\\Local\\Temp\\syncboard-locust\\locust_metrics_prepare_333.json"
METRICS_TMP = r"C:\Users\MONGOB~1\AppData\Local\Temp\syncboard-locust\locust_metrics_prepare_333.json.tmp"
_STEP_NAMES = ['main']
_RPS_LIMIT = None
